...
export const BOARD_OUTER_WIDTH =
  7 * CELL_PX + 6 * GRID_GAP + 2 * BOARD_PAD + 2 * BOARD_BORDER; // 460
export const BOARD_OUTER_HEIGHT =
  8 * CELL_PX + 7 * GRID_GAP + 2 * BOARD_PAD + 2 * BOARD_BORDER; // 520
